...
* Fix wrong entries of "Off-campus" and "Not in New Haven" and make sure that there aren't wrongful NAs.
...
All that work for just a few lines of code. (Note: we don't actually geocode in production, else website generation would take a long time.)
