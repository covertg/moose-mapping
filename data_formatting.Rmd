...
Finally: a simple label that pastes Epoch-Waypoint together.
...
saveRDS(data.locations, file=paste("data/locations_", t, ".rds", sep=""))
```
...
write.csv(data.places.physical, paste("data/places.physical_" , t, ".csv"), row.names=F)
```
